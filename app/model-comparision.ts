...
const complexProblem = `Solve the problem carefully.
Check all constraints and optimality.
Then output ONLY the final answer (≤ 200 chars).
...
compareFastVsReasoning().catch((error) => AiResponseError(error));